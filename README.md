    ...
    MainSection:AddToggle({
        ...
        Flag = "Auto Farm Quest",
        Value = _G.Settings.Auto_Farm_Quest,
        Callback = function(value)
            _G.Auto_Farm_Quest = value    
            _G.Settings.Auto_Farm_Quest = value
            saveSettings()
            StopTween(_G.Auto_Farm_Quest)
        end
    })
    ...
    RageBountySection:AddToggle{
        Name = "Enabled PvP",
        Flag = "EnabledPvP",
        Value = _G.Settings.Enabled_PvP,
        Callback  = function(value)
                _G.EnabledPvP = value
            _G.Settings.Enabled_PvP = value
            saveSettings()
            StopTween(_G.Auto_Kill_Player_Gun)
        end
    }
    ...
    RageBountySection:AddToggle{
        ...
        Flag = "AutoFarmBounty",
        Value = _G.Settings.AutoFarmBounty,
        Callback  = function(value)
    ...
    RageBountySection:AddToggle{
        Name = "Auto Farm Bounty Hop",
        Flag = "AutoFarmBountyHop",
        Value = _G.Settings.AutoFarmBounty_Hop,
        Callback  = function(value)
                _G.Safe_Mode = value
            saveSettings()
        end
    ...
    local St = CombatTab:CreateSection({
        Name = "Player Misc",
        Side = "Right"
    })
    ...
    local StatsSection = CombatTab:CreateSection({
        Name = "Stats",
        Side = "Left"
    })
